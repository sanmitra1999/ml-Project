...
al = os.listdir('/Users/shrey/Downloads/assn3/train/')



test = al[:30]
numTest = len(test)*1.0
filepaths = [ '/Users/shrey/Downloads/assn3/train/'+i for i in test  ]
goldCodes = [i[:-4] for i in test]
